...
Desafio desenvolvido para o CTF do VESPAS 2026, com foco prático nos principais riscos do OWASP Top 10 for LLM Applications. A base do projeto foi criada com Lovable. O laboratório explora Prompt Injection (direto e indireto), bypass de filtros e outras técnicas de exploração em aplicações com IA, incentivando análise ofensiva e implementação de defesas.
